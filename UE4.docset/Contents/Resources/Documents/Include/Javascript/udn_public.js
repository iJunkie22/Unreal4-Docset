...
$(document).ready(function () {
    ...
    $("img").each(function () {
        ...
        if ($(this).attr("src").indexOf("button") != -1 || $(this).attr("src").indexOf("icon") != -1) {
    ...
    var topicTextItems = ["Learn More", "View Now", "View More", "Visit Page", "Show Me More", "See Details"];

    //$('#topicbutton > div').each(function () {
    //    var text = topicTextItems[Math.floor((Math.random() * 6))];
    //    $(this).html(text);
    //});
